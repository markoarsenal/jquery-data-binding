module.exports = {
  "env": {
    "browser": true,
    "jquery": true      // allow jquery global variables
  },
  ...
  "rules": {
    ...
    //
    "indent": [0, 4], // this option sets a specific tab width for your code (off by default)
    ...
    "max-nested-callbacks": [0, 4], // specify the maximum depth callbacks can be nested (off by default)
    ...
    "one-var": [0, "always"], // allow just one var statement per function (off by default)
    ...
    "space-before-function-paren": [1, {"anonymous": "always", "named": "always"}], // require or disallow space before function opening parenthesis (off by default)
